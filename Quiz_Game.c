...
int main()
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to SWAPNIL'S' Quiz Game --------------------------",playername);
    ...
    printf("\n    By this way you can win upto TEN LAKHS cash prize!!!!!..........");
     ...
     switch(r1)
		...
		if (toupper(getch())=='B')
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is B.Cuttack");
		       getch();
		       break;}
        ...
        case 4:
		printf("\n\n\n2010 World Cup Football tournament was held in?");
		printf("\n\nA.Austria\t\tB.Germany\n\nC.South Africa\t\tD.Turin");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.South Africa");
		       getch();
		       break;}
		...
		printf("\n\nA.FoxyMoron\t\tB.Windchimes Communication\n\nC.Techmagnate\t\tD.YNG Media");
		if (toupper(getch())=='C' )
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.Techmagnate");
		       getch();
		       break;}}
		       }
...
void help()
    ...
    printf("\n    By this way you can win upto Ten Lakhs cash prize in INR...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****SWAPNIL'S' QUIZ GAME has been developed by SWAPNIL BHATTACHARYA using C code********");}
